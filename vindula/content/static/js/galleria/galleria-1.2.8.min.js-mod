            ...
            return {
                ...
                revertStyles: function () {
                    $.each(Utils.array(arguments), function (i, elem) {
                        ...
                        if (elem.data('styles')) {
                            elem.attr('style', elem.data('styles'))
                                .data('styles', null);
                        }
                    });
                },
...
*/
    ...
    Galleria = function () {
        ...
        var carousel = this._carousel = {
            ...
            update: function () {
                ...
                $.each(self._thumbnails, function (i, thumb) {
                    if (thumb.ready) {
                        w += thumb.outerWidth || $(thumb.container)
                            .outerWidth(true);
                        hooks[i + 1] = w;
                        h = Math.max(h, thumb.outerHeight || $(thumb.container)
                            .outerHeight(true));
                    }
                });
                ...
                carousel.width = self.$('thumbnails-list')
                    .width();
                carousel.setClasses();

                self.$('thumbnails-container')
        ...
        var tooltip = this._tooltip = {
            ...
            // move handler
            move: function (e) {
                var mouseX = self.getMousePosition(e)
                    .x,
                    mouseY = self.getMousePosition(e)
                        .y,
                    $elem = self.$('tooltip'),
                    x = mouseX,
                    y = mouseY,
        ...
        var fullscreen = this._fullscreen = {
                    ...
                    big.load(data.big, function (big) {
                        self._scaleImage(big, {
                            complete: function (big) {
                                ...
                                var image = self._controls.getActive()
                                    .image;
                                if (image) {
                                    $(image)
            ...
            _exit: function (callback) {
                ...
                // revert all styles
                Utils.revertStyles(self.get('container'), DOM()
                    .html, DOM()
                    .body);
                ...
                var big = self.getData()
                    .big,
                    image = self._controls.getActive()
                        .image;

                if (!self.getData()
                    .iframe && image && big && big == image.src) {
        ...
        var idle = this._idle = {
            ...
            remove: function (elem) {
                ...
                $.each(idle.trunk, function (i, el) {
                    if (el && el.length && !el.not(elem)
                        .length) {
                        elem.css(elem.data('idle')
                            .from);
            ...
            addEvent: function () {
                idle.bound = true;
                self.$('container')
                    .bind('mousemove click', idle.showAll);
                if (self._options.idleMode == 'hover') {
                    self.$('container')
                        .bind('mouseleave', idle.hide);
                }
            },
            ...
            hide: function () {
                ...
                if (!self._options.idleMode || self.getIndex() === false || self.getData()
                    .iframe) {
                    return;
                }
        ...
        var lightbox = this._lightbox = {
            ...
            init: function () {
                ...
                var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image commnets slide social',
                    ...
                    cssMap = {
                        ...
                        close: abs + 'top:0px;right:0px;height:20px;width:20px;background:#fff;text-align:center;cursor:pointer;color:#444;font:16px/22px arial,sans-serif;z-index:99999',
                        ...
                        commnets: abs + 'background-color:#fff;top:10px;left:10px;right:10px;bottom:10px;overflow:hidden;width:300px;',
                ...
                $(el.image)
                    .append(lightbox.image.container);

                $(DOM()
                    .body)
                    .append(el.overlay, el.box);
            ...
            show: function (index) {
                ...
                $(lightbox.elems.box)
                    .toggleClass('iframe', !! data.iframe);

                lightbox.image.load(data.iframe || data.big || data.image, function (image) {

                    lightbox.width = image.isIframe ? $(window)
                        .width() : image.original.width;
                    lightbox.height = image.isIframe ? $(window)
                ...
                var link = data.big.substring(0, data.big.lastIndexOf('/')),
				    frame = '<iframe src="' + link + '/view_comments_imagens" style="width:100%;height:100%;overflow-x: hidden;position:relative;top:5px;"> </iframe>';
                $(lightbox.elems.commnets)
                    .append($(frame));
            }
        };
    ...
    */
        ...
        _init: function () {
            ...
            this.$('container')
                .addClass(Galleria.TOUCH ? 'touch' : 'notouch');
            ...
            $.each(new Array(2), function (i) {
                ...
                $(image.container)
                    ...
                    .prepend(self._layers[i] = $(Utils.create('galleria-layer'))
                    .css({
                    position: 'absolute',
                    top: 0,
                    left: 0,
                ...
                (function (images) {
                    ...
                    var swipeStart = [0, 0],
                        ...
                        upHandler = function (e) {
                            ...
                            if (Utils.timestamp() - tid < 1000 && Math.abs(swipeStart[0] - swipeStop[0]) > limitX && Math.abs(swipeStart[1] - swipeStop[1]) < limitY) {
                    ...
                    images.bind(ev.start, function (e) {
                        ...
                        images.bind(ev.move, moveHandler)
                    ...
                    this.$('stage')
                        ...
                        return function (e) {
                            ...
                            if ((now - last < 500) && (cx - lx < 20) && (cy - ly < 20)) {
                                ...
                                e.preventDefault();
                                self.$('stage')
                                    .unbind('touchend', arguments.callee);
                                return;
                            }
                            last = now;
                            lx = cx;
        ...
        _createThumbnails: function (push) {
			...
			try{
			  ...
			  this.get('total').innerText = this.getDataLength();
			}
                ...
                onThumbLoad = function (thumb, callback) {
                    ...
                    thumb.scale({
                        ...
                        complete: function (thumb) {
                            ...
                            o.thumbQuality === true || (o.thumbQuality === 'auto' && thumb.original.width < thumb.width * 3));
        ...
        _run: function () {
            ...
            Utils.wait({
                ...
                until: function () {
                    ...
                    self._stageWidth = self.$('stage')
                        .width();
                    self._stageHeight = self.$('stage')
                        .height();
...
$(document).mousemove(function(e) {
    ...
    */
        ...
        getMousePosition: function (e) {
            return {
                x: e.pageX - this.$('container')
                    .offset()
                    .left,
                y: e.pageY - this.$('container')
                    .offset()
                    .top
            };
        },
        ...
        addPan: function (img) {
            ...
            var self = this,
                ...
                calculate = function (e) {
                    ...
                    active = true;
                    x = self.getMousePosition(e)
                        .x;
                    y = self.getMousePosition(e)
                        .y;
                },
...
this.attachKeyboard({
    ...
    */
        ...
        appendChild: function (parentID, childID) {
            this.$(parentID)
                .append(this.get(childID) || childID);
            return this;
        },
...
this.prependChild( 'info', 'myElement' );
    ...
    */
        ...
        prependChild: function (parentID, childID) {
            this.$(parentID)
                .prepend(this.get(childID) || childID);
            return this;
        },
    ...
    */
        ...
        rescale: function (width, height, complete) {
            ...
            var scale = function () {
                ...
                // set stagewidth
                self._stageWidth = width || self.$('stage')
                    .width();
                self._stageHeight = height || self.$('stage')
                    .height();
    ...
    */
        ...
        setCounter: function (index) {
			...
			try{
              ...
              this.get('current').innerText = index;
            }
    ...
    */
        ...
        setInfo: function (index) {
            ...
            $.each(['title', 'description'], function (i, type) {
                ...
                if ( !! data[type]) {
                    elem[data[type].length ? 'show' : 'hide']()
                        .html(data[type]);
                } else {
                    elem.empty()
                        .hide();
...
*/
    ...
    Galleria.on = function (type, callback) {
        ...
        // hash the bind
        var hash = type + callback.toString()
            .replace(/\s/g, '') + Utils.timestamp();
        ...
        scale: function (options) {
            ...
            Utils.wait({
                ...
                success: function () {
                    ...
                    $.each(options.position.toLowerCase()
                        .split(' '), function (i, value) {
                        if (value === 'center') {
                            value = '50%';
                        }
    ...
    $.fn.galleria = function (options) {
        ...
        return this.each(function () {
            ...
            if (!$.data(this, 'galleria')) {
                $.data(this, 'galleria', new Galleria()
                    .init(this, options));
            }
        });

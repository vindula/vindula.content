...
Galleria = function() {
    ...
    var lightbox = this._lightbox = {
        ...
        init : function() {
            ...
            var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image commnets slide social',
                el = {},
                op = self._options,
                css = '',
                ...
                cssMap = {
                    ...
                    content:    abs+'background-color:#000;top:10px;left:10px;right:10px;bottom:10px;overflow:hidden',
                    info:       abs+'bottom:30px;left:10px;right:10px;color:#FFF;font:11px/13px arial,sans-serif;height:13px',
					...
					commnets:   abs+'background-color:#fff;top:10px;left:10px;right:10px;bottom:10px;overflow:hidden;',
					slide:      abs+'width:62%;height:100%;top:0px;left:0px;',
					social:     abs+'width:40%;height:100%;top:0px;right:0px;'
            ...
            // append the elements
            $.each({
				    box: 'shadow slide social close',
                    slide: 'content prevholder nextholder ',
					social: 'commnets',   
                    info: 'title counter',
                    content: 'info image',
                    prevholder: 'prev',

...
PROFILE_ID = 'profile-vindula.content:default'
...
def add_catalog_indexes(context, logger=None):
    ...
    if logger is None:
        ...
        logger = logging.getLogger('sebrae.sgc.conteudos')
...
def import_various(context):
    ...
    if context.readDataFile('vindula_content_various.txt') is None:
        return
    logger = context.getLogger('vindula.content')
